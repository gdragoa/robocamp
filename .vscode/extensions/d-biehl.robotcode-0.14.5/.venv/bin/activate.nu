...
def-env activate-virtualenv [] {
    ...
    let virtual_env = '/home/runner/work/robotcode/robotcode/.venv'
    let bin = 'bin'
    let path_sep = ':'
    ...
    let virtual_prompt = if ('robotcode-py3.8' == '') {
...
alias deactivate = source '/home/runner/work/robotcode/robotcode/.venv/bin/deactivate.nu'
